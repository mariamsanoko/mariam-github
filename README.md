...
Je suis **Mariam Sanoko**, conceptrice-développeuse d’applications (CDA), consultante fonctionnelle Microsoft Dynamics 365 et spécialiste des solutions **No-Code / Low-Code**.
Je conçois des applications intelligentes, des automatisations métier, des prototypes UX/UI, ainsi que des solutions accessibles pour entreprises et créateurs.
...
* **UX/UI & Design**
  Adobe XD • Figma • Photoshop • Illustrator • InDesign
